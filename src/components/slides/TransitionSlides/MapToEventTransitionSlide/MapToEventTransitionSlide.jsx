            ...
            <div className="transition_content">
                <div className="transition_text">
                    <p>Our second question concerns the impact of certain events on emergency calls. <br/>
                        ...
                        For example, are there more car accidents during SuperBall? Can we visualize a decrease of 911 calls during the pandemic ? <br/>
                        In the next page, you will find a chart of the type of accident (EMS, Fire, Traffic) over a period of time.
                        You can also filter by the type of event (SuperBowl, Covid-19, etc.) to visualize the impact of the event on the number of calls.
                    </p>
                </div>
            </div>
        </Slide>
